...
async function get_cert() {
    ...
    var accountKeypair = await Keypairs.generate({
        kty: 'EC',
        format: 'jwk'
    });
    ...
    var serverKeypair = await Keypairs.generate({
        kty: 'RSA',
        format: 'jwk'
    });
    ...
    var serverPem = await Keypairs.export({
        jwk: serverKey
    });
    var fs = require("fs");
    ...
    let defaultDomainName = "placeholder.com";
    if (defaultDomainName == "placeholder.com") {
        console.log("You need to replace the default domain names");
    }
    var domains = ["placeholder.com"];
    ...
    if (projectId == "placeholder-project-id") {
        console.log("You need to replace the default project id");
    }
    if (zonename == "placeholder-zonename") {
        console.log("You need to replace the default zonename");
    }
