...
module.exports.create = function(config) {
    ...
    return {
        ...
        set: async function(data) {
            ...
            var recordDnsName;
            if (ch.wildcard) {
                recordDnsName = generateDnsNameForWildcard(ch.dnsHost, ch.altname) + ".";
            } else {
		    ...
		    a++;
		    console.log("status pending, will try up to 10 times. currently at attempt: " + a);
        ...
        get: async function(data) {
            ...
            var recordDnsName;
            if (ch.wildcard) {
                recordDnsName = generateDnsNameForWildcard(ch.identifier.value, ch.altname) + ".";
            } else {
		...
		if (records[0].length == 0) { //just to make it explicit
			return null;
		}
